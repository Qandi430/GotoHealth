	...
	<div id="wrap">      
      <div class="subNav">
        ...
        <ul class="subNav-list">
          <li class="subNav-list-item active"  role="presentation"><a onclick="doAction('protain.do')" class="subNav-list-item-link" href="#popularity" aria-controls="popularity" role="tab" data-toggle="tab">인기도순</a></li>
          ...
          <li class="subNav-list-item" role="presentation"><a onclick="doAction('recent.do')" class="subNav-list-item-link" href="#latest" aria-controls="latest" role="tab" data-toggle="tab">최신 등록순</a></li>
		            ...
		            <div class="split">
		              <div class="split-left">
		                <div class="totem">
		                  ...
		                  <p class="totem-bd">${a.title}</p>
		                  <p class="totem-ft">${a.price}</p>
		                </div>
		              </div>
