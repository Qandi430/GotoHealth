		...
		<div class="container page_qna">
			<div class="inner">
				<ul class="tab_menu_category cf">
					<li><a href="<c:url value="/jsp/community/notice_list.jsp"/>">공지사항</a></li>
					<li><a href="<c:url value="/jsp/community/free_list.jsp"/>">자유게시판</a></li>
					<li class="active"><a href="<c:url value="/jsp/community/gallery_list.jsp"/>">갤러리</a></li>
				...
				<table class="table_qna" width="100%" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<th>작성일</th>	
						<td class="reg-date">2015.03.22 13:31</td>
						<th>조회수</th>
						<td class="cnt">31</td>
						<th>추천수</th>
						<td class="cnt">21</td>
					...
					<tr>
						<td colspan="8"><img src="<c:url value="/img/community/ex.jpg"/>" alt=""></td>
					</tr>	
				</table>
				<div class="rec">
				...
				<div class="update-deletebutton">
					<a href="<c:url value="/jsp/community/gallery_update.jsp"/>" type="button" class="btn btn-default btn-lg" style="color: black; text-decoration: none">수정</a>
					<a href="#" type="button" class="btn btn-default btn-lg" style="color: black; text-decoration: none">삭제</a>
					<a href="<c:url value="/jsp/community/gallery_list.jsp"/>" type="button" class="btn btn-default btn-lg" style="color: black; text-decoration: none">목록</a>
				</div>	
				<div class="rn">
				</div>
				<table class="table_qna" width="100%" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td><a id="comment" href="<c:url value="/jsp/community/gallery_detail.jsp"/>" type="button" class="btn btn-default comment" style="float: right">등록</a></td>
					</tr>			
				</table>
