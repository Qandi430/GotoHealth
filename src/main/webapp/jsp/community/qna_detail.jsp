		...
		<div class="container page_qna">
			<div class="inner">
				<ul class="tab_menu_category cf">
					...
					<li class="active"><a href="<c:url value="/jsp/community/qna_list.jsp"/>">질문과 답변</a></li>
				</ul>
				<table class="table_qna" width="100%" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<th>작성일</th>	
						<td class="reg-date" colspan="3">2015.03.22 13:31</td>
				...
				<div class="update-deletebutton">
					<a href="<c:url value="/jsp/community/qna_update.jsp"/>" class="btn btn-default btn-lg" style="color: black; text-decoration: none">수정</a>
					<a href="#" class="btn btn-default btn-lg" style="color: black; text-decoration: none">삭제</a>
					<a href="<c:url value="/jsp/community/qna_list.jsp"/>" class="btn btn-default btn-lg" style="color: black; text-decoration: none">목록</a>
				</div>	
				<div class="rn">
				</div>
				<table class="table_qna" width="100%" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td><a id="comment" href="<c:url value="/jsp/community/qna_detail.jsp"/>" type="button" class="btn btn-default comment" style="float: right">등록</a></td>
					</tr>		
				</table>
