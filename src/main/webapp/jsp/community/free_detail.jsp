		...
		<div class="container page_qna">
			<div class="inner">
				<ul class="tab_menu_category cf">
					...
					<li class="active"><a href="<c:url value="/jsp/community/free_list.jsp"/>">자유게시판</a></li>
				...
				<div class="update-deletebutton cf">
					<a href="<c:url value="/jsp/community/free_update.jsp"/>" class="btn btn-default btn-lg" style="color: black; text-decoration: none">수정</a>
					<a href="#" class="btn btn-default btn-lg" style="color: black; text-decoration: none">삭제</a>
					<a href="<c:url value="/jsp/community/free_list.jsp"/>" class="btn btn-default btn-lg" style="color: black; text-decoration: none">목록</a>
				</div>	
				<div class="rn">
				</div>
				<table class="table_qna" width="100%" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td><a id="comment" href="<c:url value="/community/free_detail.jsp"/>" type="button" class="btn btn-default comment" style="float: right">등록</a></td>
					</tr>	
				</table>
