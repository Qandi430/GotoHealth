		...
		<div class="container page_qna">
			<div class="inner">
				...
				<div class="box_buttons cf">
					<a href="<c:url value="/jsp/community/exercise_list.jsp"/>" class="btn_left">취소하기</a>
					<a href="<c:url value="/jsp/community/exercise_list.jsp"/>" class="btn_right">등록하기</a>
				</div>
			</div>
		</div>
		<!-- //container -->
