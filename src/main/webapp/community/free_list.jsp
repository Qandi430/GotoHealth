			...
			<div class="inner">
				...
				<table class="table_notice" width="100%" cellpadding="0" cellspacing="0">
					...
					<tr class="title">
						<td>10</td>
						<td>공지</td>
						<td><a href="<c:url value="/community/free_detail.jsp"/>" style="color: black; text-decoration: none;">헬스합시다. 헬스헬스헬스!</a></td>
						<td>헬스왕</td>
						<td>2018.04.24</td>
						<td>20</td>
						<td>5</td>
				...
				<div class="write">
					<button type="button" class="btn btn-default" style="margin: 15px 1011px"><a id="write" href="<c:url value="/community/free_write.jsp"/>">글쓰기</a></button>
				</div>		
				<ul class="paging cf">
