		...
		<div class="container page_qna">
			<div class="inner">
				<ul class="tab_menu_category cf">
					<li class="way active"><a style="text-decoration: none;">운동방법</a></li>
				</ul>
				...
				<div class="update-deletebutton">
					<a href="<c:url value="/community/exercise_update.jsp"/>" type="button" class="btn btn-default btn-lg" style="color: black; text-decoration: none">수정</a>
					<a href="#" type="button" class="btn btn-default btn-lg" style="color: black; text-decoration: none">삭제</a>
					<a href="<c:url value="/community/exercise_list.jsp"/>" type="button" class="btn btn-default btn-lg" style="color: black; text-decoration: none">목록</a>
				</div>	
				<div class="rn">
				</div>
				<table class="table_qna" width="100%" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td><a id="comment" href="<c:url value="/community/exercise_detail.jsp"/>" type="button" class="btn btn-default comment" style="float: right">등록</a></td>
					</tr>
				</table>
