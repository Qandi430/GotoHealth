		...
		<div class="container page_qna">
			<div class="inner">
				...
				<div class="update-deletebutton">
					<a href="<c:url value="/community/notice_update.jsp"/>" type="button" class="btn btn-default btn-lg" style="color: black; text-decoration: none">수정</a>
					<a href="#" type="button" class="btn btn-default btn-lg" style="color: black; text-decoration: none">삭제</a>
					<a href="<c:url value="/community/notice_list.jsp" />" type="button" class="btn btn-default btn-lg" style="color: black; text-decoration: none">목록</a>
				</div>	
				<div class="rn">
				</div>
			</div>
