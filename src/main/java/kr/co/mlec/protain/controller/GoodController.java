...
//		public static void main(String[] args) {
			...
			List<Protain> listPro3 = new ArrayList<>();
			try {	

				Document doc =  Jsoup.connect("https://smartstore.naver.com/fitnessstore/category/ALL?page=1&st=SATISFACTION&dt=BIGIMAGE&size=40&free=false&cp=1").get();
...
//				System.out.println(listPro.size());
			...
			// 공유가 되었다면 페이지를 이동
			RequestDispatcher rd = request.getRequestDispatcher("/jsp/protain/good.jsp");
