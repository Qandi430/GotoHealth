...
@WebServlet("/board/shoulderList.do")
public class ListExerciseShoulderBoardController extends HttpServlet {
	...
	public void service(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		board.setCategory("어깨");
		int count = 0;
		count = mapper.boardCategoryCnt("어깨");
		int pageCount = 0;
		int pageBlock = 0;
		int startPage = 0;
		int endPage = 0;
...
//		request.setAttribute("word", word);
		...
		RequestDispatcher rd = request.getRequestDispatcher("/jsp/community/exerciseShoulder_list.jsp");
