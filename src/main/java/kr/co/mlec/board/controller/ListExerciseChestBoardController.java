...
@WebServlet("/board/chestList.do")
public class ListExerciseChestBoardController extends HttpServlet {
...
//		String word = null;
		...
		board.setCategory("가슴");
		int count = 0;
		count = mapper.boardCategoryCnt("가슴");
		int pageCount = 0;
		int pageBlock = 0;
		int startPage = 0;
		int endPage = 0;
...
//		request.setAttribute("word", word);
		...
		RequestDispatcher rd = request.getRequestDispatcher("/jsp/community/exerciseChest_list.jsp");
