...
@WebServlet("/board/backList.do")
public class ListExerciseBackBoardController extends HttpServlet {
	...
	public void service(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			...
			if(search == "") {
				count = mapper.boardCategoryCnt("등");
			}
		} catch (Exception e) {
			count = mapper.boardCategoryCnt("등");
		}
		...
		RequestDispatcher rd = request.getRequestDispatcher("/jsp/community/exerciseBack_list.jsp");
