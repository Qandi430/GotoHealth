...
@WebServlet("/board/galleryList.do")
public class ListGalleryBoardController extends HttpServlet {
...
//			list = mapper.selectBoardAllList(board);
		...
		RequestDispatcher rd = request.getRequestDispatcher("/jsp/community/gallery_list.jsp");
