...
public class ListNoticeBoardController extends HttpServlet {
...
//			list = mapper.selectBoardAllList(board);
		...
		RequestDispatcher rd = request.getRequestDispatcher("/jsp/community/notice_list.jsp");
